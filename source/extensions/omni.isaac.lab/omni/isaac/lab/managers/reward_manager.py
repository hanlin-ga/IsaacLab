...
class RewardManager(ManagerBase):
    ...
    def reset(self, env_ids: Sequence[int] | None = None) -> dict[str, torch.Tensor]:
        ...
        for key in self._episode_sums.keys():
            ...
            # if key=="object_goal_orien_diff":
            #     print("*" * 100)
            #     print("env_ids is ", env_ids)
            #     print("key is ", key)
            #     print("episodic_sum_avg  is ", episodic_sum_avg)
            #     print("self._env.max_episode_length_s is ", self._env.max_episode_length_s)
            #     print("final value  is ", episodic_sum_avg / self._env.max_episode_length_s)
            # reset episodic sum
