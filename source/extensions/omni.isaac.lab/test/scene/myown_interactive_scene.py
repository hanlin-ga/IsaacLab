...
parser.add_argument("--delta_x", type=float, default=2, help="default x distance to spawn.")
...
class MySceneCfg(InteractiveSceneCfg):
    ...
    robot_1 = Z1_CFG.replace(prim_path="{ENV_REGEX_NS}/Robot_1")
    robot_1.init_state.pos = (0.0, 0.0, 0.76)
    # articulation - robot 2
    # robot_2 = Z1_CFG.replace(prim_path="{ENV_REGEX_NS}/Robot_2")
    # robot_2.init_state.pos = (0.0, 0.0, 0.76)
...
def main():
    ...
    # robot_3_actions = scene.articulations["robot_3"].data.default_joint_pos.clone()
