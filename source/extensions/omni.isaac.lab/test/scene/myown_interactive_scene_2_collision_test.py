...
from omni.isaac.core.utils import physics as physics_utils
...
# Detect contact between the robot and the desk
contact_reporter = physics_utils.contact_reporter.ContactReporter()
