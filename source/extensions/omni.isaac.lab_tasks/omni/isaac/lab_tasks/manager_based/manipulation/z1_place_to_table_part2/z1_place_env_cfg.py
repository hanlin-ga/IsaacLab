...
class RewardsCfg:
    ...
    object_goal_tracking = RewTerm(
        ...
        params={"std": 0.05, "distance_threshold": 0.02, "minimal_height": 1.005},
        weight=5.0,
    )
...
class TerminationsCfg:
    ...
    object_joint_arrive = DoneTerm(
        func=mdp.joint_reach_goal, params={"distance_threshold": 0.02, "angle_threshold": 0.03}
    )
