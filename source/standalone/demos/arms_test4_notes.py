...
def run_simulator(sim: sim_utils.SimulationContext, entities: dict[str, Articulation], origins: torch.Tensor):
    ...
    for index, robot in enumerate(entities.values()):
        ...
        print("Robot root_state is ", root_state)
    ...
    while simulation_app.is_running():
        ...
        if count % 200 == 0:
            ...
            # else:
            #     print(f"Prim at path {prim_path} is not Xformable or does not exist.")
            # xform_api = UsdGeom.XformCommonAPI(_03_cracker_box_prim)
...
def main():
    ...
    # reference_prim.GetReferences().AddReference(usd_file_path)
    # # Set the translation using UsdGeom.XformCommonAPI
    # translation = Gf.Vec3d(2.4, 0.0, 0.5)  # Example translation vector
    # xform_api = UsdGeom.XformCommonAPI(reference_prim)
    # xform_api.SetTranslate(translation)
    ...
    # reference_prim_path = "/World/MainStage/_02_master_chef_can"
    # rigid_body_api = UsdPhysics.RigidBodyAPI.Apply(reference_prim)
    # collision_api = UsdPhysics.CollisionAPI.Apply(reference_prim)

    # reference_prim_path = "/World/MainStage/_03_cracker_box"
    # rigid_body_api = UsdPhysics.RigidBodyAPI.Apply(reference_prim)
    # collision_api = UsdPhysics.CollisionAPI.Apply(reference_prim)

    # reference_prim_path = "/World/MainStage/_04_sugar_box"
    # rigid_body_api = UsdPhysics.RigidBodyAPI.Apply(reference_prim)
    # collision_api = UsdPhysics.CollisionAPI.Apply(reference_prim)

    # reference_prim_path = "/World/MainStage/_05_tomato_soup_can"
    # rigid_body_api = UsdPhysics.RigidBodyAPI.Apply(reference_prim)
    # collision_api = UsdPhysics.CollisionAPI.Apply(reference_prim)

    # reference_prim_path = "/World/MainStage/_06_mustard_bottle"
    # rigid_body_api = UsdPhysics.RigidBodyAPI.Apply(reference_prim)
    # collision_api = UsdPhysics.CollisionAPI.Apply(reference_prim)

    # reference_prim_path = "/World/MainStage/_09_gelatin_box"
    # rigid_body_api = UsdPhysics.RigidBodyAPI.Apply(reference_prim)
    # collision_api = UsdPhysics.CollisionAPI.Apply(reference_prim)

    # reference_prim_path = "/World/MainStage/_10_potted_meat_can"
    # rigid_body_api = UsdPhysics.RigidBodyAPI.Apply(reference_prim)
    # collision_api = UsdPhysics.CollisionAPI.Apply(reference_prim)

    # reference_prim_path = "/World/MainStage/_11_banana"
    # rigid_body_api = UsdPhysics.RigidBodyAPI.Apply(reference_prim)
    # collision_api = UsdPhysics.CollisionAPI.Apply(reference_prim)

    # reference_prim_path = "/World/MainStage/_19_pitcher_base"
    # rigid_body_api = UsdPhysics.RigidBodyAPI.Apply(reference_prim)
    # collision_api = UsdPhysics.CollisionAPI.Apply(reference_prim)

    # reference_prim_path = "/World/MainStage/_21_bleach_cleanser"
    # rigid_body_api = UsdPhysics.RigidBodyAPI.Apply(reference_prim)
    # collision_api = UsdPhysics.CollisionAPI.Apply(reference_prim)

    # reference_prim_path = "/World/MainStage/_25_mug"
    # rigid_body_api = UsdPhysics.RigidBodyAPI.Apply(reference_prim)
    # collision_api = UsdPhysics.CollisionAPI.Apply(reference_prim)

    # reference_prim_path = "/World/MainStage/_24_bowl"
    # rigid_body_api = UsdPhysics.RigidBodyAPI.Apply(reference_prim)
    # collision_api = UsdPhysics.CollisionAPI.Apply(reference_prim)
