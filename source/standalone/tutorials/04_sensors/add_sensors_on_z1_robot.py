...
from omni.isaac.lab_assets import Z1_CFG # isort: skip
...
class SensorsSceneCfg(InteractiveSceneCfg):
    ...
    contact_forces = ContactSensorCfg(
        prim_path="{ENV_REGEX_NS}/Robot/z1_description/link01", update_period=0.0, history_length=6, debug_vis=True
    )
